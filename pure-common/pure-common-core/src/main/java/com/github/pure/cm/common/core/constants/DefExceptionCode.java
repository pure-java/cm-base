...
public enum DefExceptionCode implements ExceptionCode {
     ...
     * 认证失败：10402
     */
    AUTH_FAIL_10402(AppErrorCode.DEFAULT_ERROR_10000.getCode() + 402, "认证失败"),
    /**
     * account_passwd_error_10403 <p>
     * 账号密码错误:10403
     */
    ACCOUNT_PASSWD_ERROR_10403(AppErrorCode.DEFAULT_ERROR_10000.getCode() + 403, "账号密码不正确"),
    /**
     * token_invalid_10404<p>
     * 无效token:10404
     */
    TOKEN_INVALID_10404(AppErrorCode.DEFAULT_ERROR_10000.getCode() + 404, "无效的token"),
