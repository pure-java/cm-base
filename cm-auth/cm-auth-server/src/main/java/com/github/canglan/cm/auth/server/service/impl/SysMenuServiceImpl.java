...
import com.github.canglan.cm.auth.server.mapper.SysMenuMapper;
import com.github.canglan.cm.auth.server.service.ISysMenuService;
...
public class SysMenuServiceImpl extends BaseServiceImpl<SysMenuMapper, SysMenu> implements ISysMenuService {
  ...
  public boolean saveBatch(List<SysMenu> saveList) {
    ...
    //   }
    // }
    return super.daoUtil.saveBatch(saveList, AppConstants.BATCH_SAVE_SIZE);
  }
