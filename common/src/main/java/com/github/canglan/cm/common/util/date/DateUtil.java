package com.github.canglan.cm.common.util.date;
...
public final class DateUtil implements Comparable<DateUtil> {
  ...
  public static void main(String[] args) {
    System.out.println(DateUtil.newIns("20190314", "yyyyMMdd").plusDate(-1, ChronoUnit.WEEKS).weekEnd().asStr(DateUtil.DATE));
  }
  ...
  public static DateUtil newIns(String value, String pattern) {
    checkArgument(StringUtil.isNotEmpty(value), "时间字符串不能为空");
    checkArgument(StringUtil.isNotEmpty(pattern), "解析格式不能为空");
  ...
  public String asStr() {
    ...
    return localDateTime.format(DateTimeFormatter.ofPattern(DateUtil.DATE_TIME_MS));
  }
