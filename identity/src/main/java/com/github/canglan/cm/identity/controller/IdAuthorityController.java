...
public class IdAuthorityController extends BaseController<IAuthorityService> {
  ...
  public Result pageIdAuthority(@ModelAttribute PageWhere pageWhere, @ModelAttribute IdAuthority idAuthority) {
    return Result.success(PageResult.of(super.service.pageIdAuthority(pageWhere, idAuthority)));
  }
  ...
  public Result modifyIdAuthority(@ModelAttribute @Valid IdAuthority idAuthority) {
    return Result.success(super.service.saveOrUpdateIdAuthority(idAuthority));
  }
